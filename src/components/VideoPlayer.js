...
export default function VideoPlayer({
    ...
    useEffect(() => {
        ...
        const observer = new IntersectionObserver(handleIntersect, { threshold: [0, 0.25, 0.5, 1] });
    ...
    const containerClass = `${className || "video-player"} ${bg === "sand" ? "sand" : bg === "mist" ? "mist" : ""}`.trim();
    ...
    return (
        <div className={containerClass}>
            <video
                ...
                playsInline
                poster={poster}
                style={{ width: resolvedWidth, height: resolvedHeight, borderRadius: "0.5rem", objectFit: objectFit }}
            />
